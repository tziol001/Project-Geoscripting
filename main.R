...
***********************************************************************************
# prepare the data for pheno analysis and extract the greenup date for each pixel by using an assumetric Gaussian function from the phenex package 
...
****************
# this can be used in order to display some results for phenological extraction
plot(greenup)
